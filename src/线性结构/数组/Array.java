...
//************************************************************************************************
    ...
    /**
     * 在index位置插入一个新元素e O(next/2)=O(next/2)
     *
     * @param index 插入位置索引
     * @param e     插入元素
     */
...
//            throw new IllegalArgumentException("AddLast failed. Array is Full");
    ...
    private boolean isFull() {
        return getSize() == this.getCapacity();
    }
...
//************************************************************************************************
    ...
    public boolean removeElements(E e) {
        int[] indexArray = findIndexesOf(e);
